...
## Latest Releases
- Secman CLI [Secman v6.2.1](https://github.com/scmn-dev/secman/releases/tag/v6.2.1) ([CLI](https://github.com/scmn-dev/secman), _released 5 days ago_)
- Secman Desktop [20 March Release v1.1.1](https://github.com/scmn-dev/desktop/releases/tag/v1.1.1) ([Desktop](https://github.com/scmn-dev/desktop), _released 3 days ago_)
